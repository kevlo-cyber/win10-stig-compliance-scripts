<#
.SYNOPSIS
    This PowerShell script ensures that the convenience PIN option is disabled on Windows 10 systems.
...
.USAGE
    Example syntax:
    PS C:\> .\scripts\WN10-CC-000370.ps1
    This will disable the convenience PIN logon on the system.
#>
...
try {
    ...
    "STIG Registry Compliance Applied - WN10-CC-000370: Disable Convenience PIN: $(Get-Date)" | Out-File -FilePath "C:\Temp\STIG_WN10-CC-000370_$(Get-Date -Format 'yyyyMMdd_HHmmss').log" -ErrorAction SilentlyContinue
} catch { }
