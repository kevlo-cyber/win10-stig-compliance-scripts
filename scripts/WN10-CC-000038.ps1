<#
.SYNOPSIS
    This PowerShell script ensures that WDigest Authentication is disabled on Windows 10 systems.
...
.USAGE
    Example syntax:
    PS C:\> .\scripts\WN10-CC-000038.ps1
    This will disable WDigest Authentication on the system.
#>
...
try {
    ...
    "STIG Registry Compliance Applied - WN10-CC-000038: Disable WDigest Authentication: $(Get-Date)" | Out-File -FilePath "C:\Temp\STIG_WN10-CC-000038_$(Get-Date -Format 'yyyyMMdd_HHmmss').log" -ErrorAction SilentlyContinue
} catch { }
