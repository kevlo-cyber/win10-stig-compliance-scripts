<#
.SYNOPSIS
    This PowerShell script ensures that the legal banner dialog title is set correctly on Windows 10 systems.
...
.USAGE
    Example syntax:
    PS C:\> .\scripts\WN10-SO-000080.ps1
    This will set the correct legal banner dialog title on the system.
#>
...
# Set correct legal banner dialog title
...
try {
    ...
    "STIG Registry Compliance Applied - WN10-SO-000080: Set Correct Legal Banner Dialog Title: $(Get-Date)" | Out-File -FilePath "C:\Temp\STIG_WN10-SO-000080_$(Get-Date -Format 'yyyyMMdd_HHmmss').log" -ErrorAction SilentlyContinue
} catch { }
